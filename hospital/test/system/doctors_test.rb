...
class DoctorsTest < ApplicationSystemTestCase
  ...
  test "creating a Doctor" do
    ...
    fill_in "Ape doctor", with: @doctor.ape_doctor
    fill_in "Cc doctor", with: @doctor.cc_doctor
    fill_in "Celular", with: @doctor.celular
    fill_in "Nom doctor", with: @doctor.nom_doctor
    fill_in "Tipo doctor", with: @doctor.tipo_doctor
