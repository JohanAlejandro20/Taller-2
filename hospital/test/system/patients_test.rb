...
class PatientsTest < ApplicationSystemTestCase
  ...
  test "creating a Patient" do
    ...
    fill_in "Ape patient", with: @patient.ape_patient
    fill_in "Cc patient", with: @patient.cc_patient
    fill_in "Fecha nacimiento", with: @patient.fecha_nacimiento
    fill_in "Nom patient", with: @patient.nom_patient
